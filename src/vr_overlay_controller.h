#ifndef VR_OVERLAY_CONTROLLER_H
#define VR_OVERLAY_CONTROLLER_H
...
#define VR_CONTROLLER_USERVALUE  850486

class VROverlayController : public QObject {
		Q_OBJECT

	public:
		VROverlayController(QWidget* widget);
		~VROverlayController();
